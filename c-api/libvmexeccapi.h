...
typedef struct {
  ...
  void (*managed_acc_has_perm_func_ptr)(void *context, int64_t threshold, int64_t weight, int32_t source_acc_addr, int32_t target_acc_addr, int32_t perm_type, int32_t ops, int32_t res_handle);
