...
pub struct vm_exec_vm_hook_c_func_pointers {
    ...
    pub get_kda_value_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32) -> i32,
    pub get_kda_value_by_index_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32, index: i32) -> i32,
    pub get_kda_token_name_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32) -> i32,
    pub get_kda_token_name_by_index_func_ptr: extern "C" fn(context: *mut c_void, result_offset: i32, index: i32) -> i32,
    pub get_kda_token_nonce_func_ptr: extern "C" fn(context: *mut c_void) -> i64,
    pub get_kda_token_nonce_by_index_func_ptr: extern "C" fn(context: *mut c_void, index: i32) -> i64,
    pub get_kda_token_type_func_ptr: extern "C" fn(context: *mut c_void) -> i32,
    pub get_kda_token_type_by_index_func_ptr: extern "C" fn(context: *mut c_void, index: i32) -> i32,
    pub get_num_kda_transfers_func_ptr: extern "C" fn(context: *mut c_void) -> i32,
    pub get_call_value_by_token_name_func_ptr: extern "C" fn(context: *mut c_void, call_value_offset: i32, token_name_offset: i32, token_name_length: i32) -> i32,
    ...
    pub managed_multi_transfer_kda_nft_execute_func_ptr: extern "C" fn(context: *mut c_void, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32,
    ...
    pub managed_acc_has_perm_func_ptr: extern "C" fn(context: *mut c_void, threshold: i64, weight: i64, source_acc_addr: i32, target_acc_addr: i32, perm_type: i32, ops: i32, res_handle: i32),
    ...
    pub big_int_get_kda_call_value_func_ptr: extern "C" fn(context: *mut c_void, destination: i32),
    pub big_int_get_kda_call_value_by_index_func_ptr: extern "C" fn(context: *mut c_void, destination_handle: i32, index: i32),
    pub big_int_get_external_balance_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, result: i32),
    pub big_int_get_kda_external_balance_func_ptr: extern "C" fn(context: *mut c_void, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_handle: i32),
